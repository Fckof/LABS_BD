...
print "<table border='1' style='color:white;font-size:25px;margin:30px auto;border:3px solid orange;'><th>ID игры</th><th>ID разработчика</th><th>Название</th><th>Рейтинг</th><th>Дата начала работы</th><th>Дата окончания работы</th><th>Дата выпуска</th>";
