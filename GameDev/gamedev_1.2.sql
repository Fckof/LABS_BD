...
--
-- Host: localhost
-- Generation Time: May 31, 2021 at 09:51 PM
...
(1, 3, 'Watch Dogs', '21', 547, '2012-05-04 00:00:00', '2014-08-07 00:00:00', '2014-08-07 00:00:00'),
(2, 6, 'Metro 2033', '55', 1300, '2008-07-03 00:00:00', '2010-05-23 00:00:00', '2010-07-23 00:00:00'),
...
if (old.`Цена за копию` <> new.`Цена за копию`) then
SET @old_date=(SELECT max(`Дата обновления`) as latest FROM `изменение цен игр` WHERE `Название`= new.`Название`);
IF @old_date is null THEN
	SET @old_date=(SELECT `Дата выпуска` FROM `игры` WHERE `игры`.`Название`=new.`Название`);
end IF;
 INSERT INTO `изменение цен игр`(`Название`,`Старая цена`,`Новая цена`,`Дата до обновления`,`Дата обновления`) VALUES(new.`Название`,old.`Цена за копию`,new.`Цена за копию`,@old_date,NOW());
 end if;
END
$$
DELIMITER ;
...
IF (old.`Рейтинг` <> new.`Рейтинг`) then
SET @old_date=(SELECT max(`Дата обновления`) as latest FROM `изменение рейтинга` WHERE `Название`= new.`Название`);
IF @old_date is null THEN
	SET @old_date=(SELECT `Дата выпуска` FROM `игры` WHERE `игры`.`Название`=new.`Название`);
end IF;
 INSERT INTO `изменение рейтинга`(`Название`,`Старый рейтинг`,`Новый рейтинг`,`Дата до обновления`,`Дата обновления`) VALUES(new.`Название`,old.`Рейтинг`,new.`Рейтинг`,@old_date,NOW());
 end if;
END
$$
DELIMITER ;
...
INSERT INTO `изменение рейтинга` (`Название`, `Старый рейтинг`, `Новый рейтинг`, `Дата до обновления`, `Дата обновления`) VALUES
('Watch Dogs', 12, 15, '2014-08-07 00:00:00', '2021-05-30 14:45:09'),
('Watch Dogs', 15, 21, '2021-05-30 14:45:09', '2021-05-30 14:45:26'),
('Metro 2033', 25, 55, '2010-07-23 00:00:00', '2021-05-30 14:46:43');
...
INSERT INTO `изменение цен игр` (`Название`, `Старая цена`, `Новая цена`, `Дата до обновления`, `Дата обновления`) VALUES
('Watch Dogs', 3000, 2350, '2014-08-07 00:00:00', '2021-05-30 14:45:39'),
('Watch Dogs', 2350, 547, '2021-05-30 14:45:39', '2021-05-30 14:45:53'),
('Metro 2033', 1000, 1300, '2010-07-23 00:00:00', '2021-05-30 14:47:15');
...
(1, 1, 1, 1, 5, 2, 30000, '2012-07-06', '2013-03-24'),
(2, 1, 1, 2, 7, 1, 69000, '2012-05-07', '2012-07-04'),
(3, 1, 1, 3, 4, 2, 130000, '2013-04-03', '2014-08-07'),
(4, 2, 2, 4, 2, 2, 280000, '2008-07-03', '2010-05-20'),
(5, 2, 2, 5, 6, 5, 300000, '2010-05-28', '2010-07-23'),
(6, 11, 6, 7, 4, 2, 87000, '2008-06-05', '2011-12-23'),
(7, 12, 6, 8, 1, 3, 80000, '2011-12-29', '2012-01-02'),
(8, 13, 10, 9, 5, 3, 56000, '2010-09-12', '2012-01-30'),
(9, 14, 10, 10, 1, 1, 40000, '2010-09-12', '2011-08-08'),
(10, 15, 12, 11, 4, 5, 46000, '2002-03-14', '2002-04-09'),
(11, 16, 12, 12, 2, 3, 85970, '2000-04-12', '2002-02-07'),
(12, 17, 3, 13, 8, 3, 130000, '2013-09-16', '2015-06-09'),
(13, 18, 3, 14, 7, 3, 67000, '2015-07-08', '2016-02-21');
