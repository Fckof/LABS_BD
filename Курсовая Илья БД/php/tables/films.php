...
print "<table border='1' style='color:white;font-size:21px;margin:20px auto;border:2px solid black;'><th>ID_филм</th><th>Рабочее название</th><th>Окончательное название</th><th>Год</th><th>Тематика</th><th>Режиссёр</th><th>Длительность</th><th>Бюджет</th><th>Реальные_затраты</th><th>Дата решения о съёмке</th><th>Дата начала съёмки</th><th>Дата конца съёмки</th><th>Дата премьеры</th>";
