				...
				<div class="nav__folder">
					...
					<div class="select__block">
						...
						<select name="sel" id="select" class="selQuery">
							...
							<option value="temporal">Изменение цен смартфонов</option>
							<option value="up">Обновить цену смартфона</option>
							<option value="ins">Добавить продавца</option>
							<option value="del">Удалить продавца</option>
						</select>
				...
				$('.main').css("display", "none");
					switch($('#select').val()) {
						...
						//action="php/hard-requests/up.php
							...
							break;
						case "ins":
							$('<form class="form_data" id="form2"><div class="input-field"><label for="surname">ID магазина <br><input type="number" name="id" class="input" id="surname" placeholder="" autocomplete="off" required  minlength="1"></label></div><div class="input-field"><label for="fathername">ФИО <br><input type="text" name="name" class="input" id="fathername" placeholder="" autocomplete="off" required pattern="^[A-Za-zА-Яа-я]+$" minlength="3"><br><input type="submit" name="send" class="input" id="button-submit" value="Добавить" ></div></form>').appendTo('.output')
							break;
						case "del":
