...
--
-- Host: localhost
-- Generation Time: Sep 12, 2021 at 10:11 PM
...
('1', 'Xiaomi Redmi Note 9 Pro 6/128GB', 'Xiaomi', 6.67, 6, 'Qualcomm Snapdragon 720G', 5020, 128, 25, 1523, '2020-09-15 00:00:00'),
...
--
ALTER TABLE `продавцы`
  MODIFY `ID_ПРОД` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
